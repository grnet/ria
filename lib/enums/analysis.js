...
const Roles = {
  ...
  GoodLegislationOffice: "Γραφείο Καλής Νομοθέτησης (ΓΓΝΚΘ)",
  LegislativeCommittee: "Νομοπαρασκευαστική Επιτροπή (ΓΓΝΚΘ)",
  LegislativeProcedureDirectorate:
    "Διεύθυνση Νομοπαρασκευαστικής Διαδικασίας (ΓΓΝΚΘ)",
  Parliament: "Βουλή",
